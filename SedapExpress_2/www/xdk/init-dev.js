...
document.addEventListener("backbutton", onBackKeyDown, false);
   // document.addEventListener("onmouseup", ononmouseup, false);
   //  document.addEventListener("onscroll", ononscroll, false);
