...
(function(a) {
    ...
    g.prototype = {
        ...
        loadContent: function(a, d, b, f, e) {
            if (a == "#ProductDetails" ||a=="#Checkout" || a=="#CheckoutAddressList" || a=="#EditAddress" || a=="#CheckoutAddNewAddress")
                {
                     
                    $(".FooterSection").css("display","none");
                    $(".searchButton").css("visibility","hidden");
                    $(".userButton").css("visibility","hidden");
                      $(".menuButton").css("visibility","hidden");
                    $(".backButtonCheckOut").remove();
                      $(".HeaderSection").append('<a class="backButtonCheckOut" onclick="CheckOutBack();"  style="visibility:visible !important;">Back</a>');
                   
                        
            }
            else if (a == "#LoginPage") {
                $.afui.hideMask();
                $(".HeaderSection").css("visibility", "hidden");
                $(".FooterSection").css("display", "none");
                $(".searchButton").css("visibility", "visible");
                $(".userButton").css("visibility", "visible");
                $(".menuButton").css("visibility", "visible");
                $(".backButtonCheckOut").remove();

                $(".view.splitview.active").css("background", "#fff");
        ...
        showBackButton: function(a, b) {
            ...
            0 !== f.length && (2 <= e && !0 !== b ? 1 !== f.find(".backButton").length && f.prepend("<a class='backButton back'>Back</a>") : f.find(".backButton").remove())
             ...
             if(f.find(".backButton").length==0)
                 {
                      if($.afui.getTitle()=='Track Order Details'){
                          var Title="'"+$.afui.getTitle().toString()+"'";
                $(".menuButton").css("display","none");
                          f.prepend('<a class="backButton back" onclick="CustomBack('+Title+')">Back</a>');
                ...
                {
                 //   $("#CheckoutHeader").append("<a class='backButton back'>Back</a>")
                }
