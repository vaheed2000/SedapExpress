...
(function(a) {
    ...
    else if($.afui.getTitle()=='Order Details')
    {
    ...
    else if($.afui.getTitle()=='Signature')
    {
    ...
    else if($.afui.getTitle()=='Delivering')
    {
     $("#Refresh").css("display","block");
     $("#Delete").css("display","none");
     $("#Refresh").css("display","none");
     ...
     else if($.afui.getTitle()=='Delivered')
    {
