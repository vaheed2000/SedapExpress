...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        PlaceOrderResult PlaceOrder(ProcessPaymentRequest processPaymentRequest, string DeliveryDate);
        ...
        IEnumerable<string> ProcessNextRecurringPayment(RecurringPayment recurringPayment, string DeliveryDate, ProcessPaymentResult paymentResult = null);
