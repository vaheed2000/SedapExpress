...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        protected virtual Order SaveOrderDetails(ProcessPaymentRequest processPaymentRequest,
            ProcessPaymentResult processPaymentResult, PlaceOrderContainer details,string DeliveryDate)
        {
            var order = new Order
            {
        ...
        public virtual PlaceOrderResult PlaceOrder(ProcessPaymentRequest processPaymentRequest, string DeliveryDate)
        {
            ...
            try
            {
                ...
                {
                    var order = SaveOrderDetails(processPaymentRequest, processPaymentResult, details, DeliveryDate);
        ...
        public virtual IEnumerable<string> ProcessNextRecurringPayment(RecurringPayment recurringPayment, string DeliveryDate, ProcessPaymentResult paymentResult = null)
        {
