...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult ConfirmOrder()
        {
            ...
            try
            {
                ...
                processPaymentRequest.PaymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer,
                    NopCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
                var placeOrderResult = _orderProcessingService.PlaceOrder(processPaymentRequest,"2018-10-10");
        ...
        public virtual IActionResult OpcSaveShippingMethod(string shippingoption,string DeliveryDate)
        {
            try
            {
                //validation
                ...
                //save
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, "DeliveryDate", DeliveryDate, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult OpcConfirmOrder()
        {
            try
            {
               ...
               string DeliveryDate = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer,
              "DeliveryDate", _storeContext.CurrentStore.Id);

              


                var placeOrderResult = _orderProcessingService.PlaceOrder(processPaymentRequest, DeliveryDate);
                if (placeOrderResult.Success)
                {
                    HttpContext.Session.Set<ProcessPaymentRequest>("OrderPaymentInfo", null);
                    var postProcessPaymentRequest = new PostProcessPaymentRequest
