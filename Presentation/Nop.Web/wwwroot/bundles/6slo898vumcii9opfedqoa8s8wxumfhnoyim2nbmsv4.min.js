 ...
 */
$(document).ready(function(){$(window).bind("scroll",function(){var n=$("div.header").height(),t=$("div.header").width();$(window).scrollTop()>n?$(".main-menu").addClass("goToTop").width(t):$(".main-menu").removeClass("goToTop")});$("#exit").click(function(){$(".responsive").hide();$(".master-wrapper-page").css("margin-top","0")});$(".block .title").click(function(){var n=window,t="inner",i;"innerWidth"in window||(t="client",n=document.documentElement||document.body);i={width:n[t+"Width"],height:n[t+"Height"]};i.width<991&&($(this).siblings(".listbox").slideToggle("slow"),$(this).toggleClass("arrow-up-down"))});$("#flyout-cart").on("mouseenter",function(){$("#flyout-cart-wrapper").addClass("active")});$("#flyout-cart").on("mouseleave",function(){$("#flyout-cart-wrapper").removeClass("active")});$("#home-category-slider,#sub-category-slider,#manufacturer-slider").owlCarousel({loop:!0,dots:!1,nav:!0,navText:["prev","next"],autoPlay:!1,lazyLoad:!0,responsive:{0:{items:1},640:{items:1},641:{items:3},768:{items:3},980:{items:4},1199:{items:4}}});$("#product-slider").owlCarousel({loop:!0,dots:!1,nav:!0,navText:["prev","next"],autoPlay:!0,lazyLoad:!0,responsive:{0:{items:2},640:{items:2},641:{items:3},768:{items:3},980:{items:3},1199:{items:3}}});$("#crosssell-products-slider,#home-bestseller-slider,#home-features-slider,#related-products-slider,#also-purchased-products-slider").owlCarousel({loop:!0,dots:!1,nav:!0,navText:["prev","next"],autoPlay:!1,lazyLoad:!0,responsive:{0:{items:1},640:{items:1},641:{items:3},768:{items:3},980:{items:3},1199:{items:4}}});$("#home-news-slider").owlCarousel({loop:!0,dots:!1,nav:!0,navText:["prev","next"],autoPlay:!1,lazyLoad:!0,responsive:{0:{items:1},640:{items:1},768:{items:2},980:{items:2},1199:{items:2}}}),function(n){n.fn.backTop=function(t){var i=this,r=n.extend({position:400,speed:500},t),f=r.position,u=r.speed;i.css({right:40,bottom:40,position:"fixed"});n(document).scroll(function(){var t=n(window).scrollTop();console.log(t);t>=f?i.fadeIn(u):i.fadeOut(u)});i.click(function(){n("html, body").animate({scrollTop:0},{duration:1200})})}}(jQuery);$("#backTop").backTop({position:200,speed:500})});