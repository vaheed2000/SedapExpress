...
(function(a) {
    ...
    g.prototype = {
        ...
        loadContent: function(a, d, b, f, e) {
            if(a=="#Checkout" || a=="#CheckoutAddressList" || a=="#EditAddress" || a=="#CheckoutAddNewAddress")
                {
            ...
            if (!1 === this.hasLaunched || this.launchCompleted) this.hasLaunched = !0;
                ...
                var c = this,
                    d = a.create("div", {
                        id: "afui_mask",
                        className: "ui-loader",
                        html: "<span class='ui-icon ui-icon-loading spin'></span>"
                    }).css({
                        "z-index": 2E4,
                        display: "none"
                    });
                ...
                a(document).on("click", ".backButton, [data-back]", function() {
                    $("#Scan").css("visibility","hidden");
                       if($.afui.getTitle()!="Dashboard"){
        RefreshDashboard();
                          if($.afui.getTitle().charAt(0)=='#' && Flag_StatusSubmit==false) {
           StatusUpdate("BackButton");
